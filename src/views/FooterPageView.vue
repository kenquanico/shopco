  ...
  <div class="fade-up">
    ...
    <template v-if="slug === 'about'">
      <section class="page-shell grid overflow-hidden rounded-[32px] bg-black text-white lg:grid-cols-2">
        ...
        <img src="https://images.unsplash.com/photo-1529139574466-a303027c1d8b?auto=format&fit=crop&w=1000&q=85" alt="DRAPÉ fashion community" class="min-h-[420px] h-full w-full object-cover grayscale" />
      </section>
    ...
    <template v-else-if="slug === 'support'">
      <section class="page-shell grid gap-6 lg:grid-cols-[.8fr_1.2fr]">
        <div class="rounded-[32px] bg-black p-8 text-white md:p-12"><Headphones :size="42" /><h1 class="display-font mt-20 text-5xl uppercase sm:text-6xl">HOW CAN WE HELP?</h1><p class="mt-5 text-white/60">{{ page.intro }}</p><div class="mt-10 space-y-3 text-sm"><p class="flex items-center gap-3"><Clock3 :size="17" /> Mon–Sat, 9AM–6PM</p><p class="flex items-center gap-3"><Mail :size="17" /> support@drape.com</p></div></div>
    ...
    <template v-else-if="slug === 'account'">
      <section class="page-shell grid gap-5 lg:grid-cols-[320px_1fr]"><aside class="rounded-[28px] bg-black p-7 text-white"><div class="grid h-16 w-16 place-items-center rounded-full bg-white/10"><UserRound :size="30" /></div><h1 class="mt-8 text-3xl font-bold">Welcome back.</h1><p class="mt-2 text-sm text-white/45">Sign in to unlock your DRAPÉ space.</p><button class="mt-8 w-full rounded-full bg-white py-3.5 font-medium text-black">Sign in</button><p class="mt-4 text-center text-xs text-white/35">Demo membership experience</p></aside>
    ...
    <template v-else-if="slug === 'payments'">
      <section class="page-shell grid gap-5 lg:grid-cols-2"><div class="rounded-[32px] bg-black p-8 text-white md:p-12"><WalletCards :size="42" /><h1 class="display-font mt-20 text-5xl uppercase sm:text-7xl">PAY YOUR WAY.</h1><p class="mt-6 max-w-lg text-white/55">{{ page.intro }}</p></div><div class="relative min-h-[430px] overflow-hidden rounded-[32px] bg-[#d6ff38] p-8"><div class="absolute -right-16 -top-16 h-56 w-56 rounded-full border-[40px] border-black/5"></div><p class="text-xs font-bold uppercase tracking-widest">DRAPÉ WALLET</p><div class="mt-12 rounded-[24px] bg-black p-6 text-white shadow-2xl"><div class="flex justify-between"><CreditCard /><span class="font-bold">VISA</span></div><p class="mt-20 tracking-[.25em]">•••• •••• •••• 2048</p><div class="mt-5 flex justify-between text-xs text-white/50"><span>DRAPÉ MEMBER</span><span>09/29</span></div></div><p class="mt-7 flex items-center gap-2 text-sm font-medium"><ShieldCheck :size="18" /> Protected checkout on every order</p></div></section>
    ...
    <template v-else-if="slug === 'tutorial'">
      <section class="page-shell grid overflow-hidden rounded-[32px] bg-[#111] text-white lg:grid-cols-[.8fr_1.2fr]"><div class="p-8 md:p-12"><Code2 :size="42" /><h1 class="display-font mt-20 text-5xl uppercase sm:text-6xl">BUILD THE<br />STOREFRONT.</h1><p class="mt-5 text-white/50">{{ page.intro }}</p></div><div class="bg-[#1c1c1c] p-6 md:p-10"><div class="mb-7 flex items-center gap-2 text-xs text-white/40"><span class="h-3 w-3 rounded-full bg-red-400"></span><span class="h-3 w-3 rounded-full bg-yellow-400"></span><span class="h-3 w-3 rounded-full bg-green-400"></span><span class="ml-3">drape/course.vue</span></div><pre class="overflow-x-auto text-sm leading-7 text-green-300"><code>&lt;template&gt;
...
&lt;/script&gt;</code></pre></div></section>
    ...
    <template v-else-if="slug === 'blog'">
      <section class="page-shell border-y border-black py-10 text-center"><p class="text-xs font-bold uppercase tracking-[.35em]">The DRAPÉ Journal</p><h1 class="display-font mt-5 text-6xl uppercase sm:text-8xl">HOW TO</h1><p class="mt-4 text-black/50">Ideas for getting dressed with more intention.</p></section>
    ...
    <template v-else-if="slug === 'youtube'">
      <section class="bg-black py-12 text-white"><div class="page-shell"><p class="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-white/45"><Video :size="17" /> DRAPÉ Studio</p><h1 class="display-font mt-5 text-5xl uppercase sm:text-7xl">WATCH. LEARN.<br />WEAR IT YOUR WAY.</h1><p class="mt-6 max-w-xl text-white/55">{{ page.intro }}</p></div></section>
