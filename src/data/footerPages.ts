...
export const footerPages: Record<string, FooterPage> = {
  about: {
    ...
    sections: [
      { title: 'Our story', body: 'SHOP.CO began with a simple idea: great style should feel accessible, expressive, and effortless. We bring together everyday essentials and standout pieces so every wardrobe can feel personal.' },
      ...
      { title: 'Our community', body: 'More than 30,000 customers use SHOP.CO to explore new looks, revisit trusted staples, and build wardrobes that feel unmistakably their own.' },
    ],
  },
  features: {
    title: 'Features',
  ...
  career: {
    ...
    sections: [
      { title: 'Life at SHOP.CO', body: 'We are a curious, customer-focused team working across design, technology, merchandising, operations, and support.' },
  ...
  support: {
    ...
    intro: 'Find fast answers or get in touch with the SHOP.CO support team.',
    sections: [
      { title: 'Contact us', body: 'Our support team is available Monday through Saturday, 9:00 AM–6:00 PM.', bullets: ['Email: support@shop.co', 'Phone: +1 (800) 555-SHOP', 'Typical response time: within one business day'] },
  ...
  terms: {
    ...
    intro: 'These terms explain the rules that apply when you browse or shop with SHOP.CO.',
    sections: [
      ...
      { title: 'Content and trademarks', body: 'SHOP.CO branding, interface design, copy, and original content may not be reproduced or used commercially without permission.' },
  ...
  account: {
    ...
    sections: [
      ...
      { title: 'Account security', body: 'Never share your password or verification codes. SHOP.CO support will never ask for your complete payment details.' },
    ],
  },
  deliveries: {
  ...
  payments: {
    ...
    sections: [
      { title: 'Accepted methods', body: 'SHOP.CO supports major credit and debit cards, PayPal, and eligible mobile wallet payments.' },
  ...
  youtube: {
    ...
    sections: [
      ...
      { title: 'Coming soon', body: 'The SHOP.CO video channel is not connected in this demonstration. This page is ready for the final playlist embeds.' },
    ],
  },
}
